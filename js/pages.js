...
` + argSection('👤','#E8F5E9','Data Pegawai','Auto-fill dari database pegawai yang sedang login atau dipilih',[
  ...
  ['transport','⚡ Computed','computed','Dikosongkan pada kwitansi; transport tetap tersedia di rekap','—'],
  ['total','⚡ Computed','computed','Total uang harian per peserta untuk kwitansi<br><span class="text-muted text-sm">uang_harian × lama perjalanan</span>','Rp 170.000'],
  ['total_terbilang','⚡ Computed','computed','Total uang harian per peserta dalam kata-kata Bahasa Indonesia','Seratus Tujuh Puluh Ribu Rupiah'],
  ...
  ['nominal','⚡ Computed','computed','Total uang harian format angka di kwitansi (tanpa "Rp")','170,000'],
...
[
  ...
  ['transport_peserta','🔁 Loop','loop','Dikosongkan pada kwitansi; transport tetap tersedia di rekap','—'],
  ['total_peserta','🔁 Loop','loop','Total uang harian peserta ini untuk kwitansi','Rp 170.000'],
  ['total_peserta_terbilang','🔁 Loop','loop','Total uang harian peserta ini dalam kata-kata Bahasa Indonesia','Seratus Tujuh Puluh Ribu Rupiah'],
  ['nominal_peserta','🔁 Loop','loop','Total uang harian peserta format angka untuk kwitansi','170,000'],
