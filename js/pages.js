...
` + argSection('👤','#E8F5E9','Data Pegawai','Auto-fill dari database pegawai yang sedang login atau dipilih',[
  ...
  ['untuk_pembayaran','⚡ Computed','computed','Teks singkat "Untuk Pembayaran" di kwitansi tanpa maksud kegiatan<br><span class="text-muted text-sm">"Biaya Uang Harian Perjalanan Dinas [jenis] ke [tujuan]" — [tujuan] ikut nama tempat manual kalau diisi</span>','Biaya Uang Harian Perjalanan Dinas Dalam Daerah ke BPKAD'],
